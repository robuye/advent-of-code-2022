defmodule AOC.Day4.Test do
  ...
  test "find_the_answer_p2/0" do
    ...
    assert p1.overlaps_some == false
    assert p2.overlaps_some == false
    assert p3.overlaps_some == true
    assert p4.overlaps_some == true
    assert p5.overlaps_some == true
    assert p6.overlaps_some == true
  end
end
